...
export default function Home({
  ...
  return (
    <div className="relative min-h-screen bg-white text-gray-800">
              ...
              <div className="md:pt-[55px] pt-[42px]  md:pl-[8px] ">
                <div className="md:w-[750px] w-[350px] md:mt-[10px] py-1  px-1 mx-auto border border-[#7A7979] rounded-full flex items-center     ">
                  ...
                  <Button
                    ...
                    className="bg-[#4C2B21] font-gilroy hover:shadow-xl shadow-gray-700 ml-[80px]  md:ml-[34px]  text-[8px]  md:text-[24px]  text-white py-2 md:py-[25px] rounded-full hover:bg-brown-800"
                  >
      ...
      <footer className="bg-[#FBF8F4]  md:pr-[140px]  md:px-[20px] md:py-10 border-t border-gray-300">


        <div className="grid grid-flow-row md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-2  items-center justify-between  ">
        <div className=" justify-center md:pl-[20px] flex">
    ...
    "
          ...
          <div className="text-black 5px] md:text-[22px] pt-[40px] md:pt-[0px] md:pb-0 pb-[30px]  md:pr-[10px] md:mb-[12px] text-center ">
        ...
        <div className=" bg-[#FBF8F4] justify-center items-center text-[12px]  float-right md:text-[16px]  py-2   md:pr-[36px] pr-[16px] md:text-sm    md:px-[86px] border-gray-300 md:pt-10  text-[#3F3E3E] ">
